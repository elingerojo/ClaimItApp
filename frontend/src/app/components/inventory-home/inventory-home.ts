...
import { InviteWelcome } from '../invite-welcome/invite-welcome';

@Component({
  selector: 'app-inventory-home',
  standalone: true,
  imports: [CommonModule, InventoryList, ActivityLog, InvitePanel, InviteWelcome], // 🧠 Registramos los subcomponentes aquí
